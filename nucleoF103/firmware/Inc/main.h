...
#define PWM_COMP_STEERING_Pin GPIO_PIN_1
#define PWM_COMP_STEERING_GPIO_Port GPIOB
...
#define PWM_MOTOR_STEERING_Pin GPIO_PIN_10
#define PWM_MOTOR_STEERING_GPIO_Port GPIOA
...
#define ENABLE_STEERING_Pin GPIO_PIN_12
#define ENABLE_STEERING_GPIO_Port GPIOC
